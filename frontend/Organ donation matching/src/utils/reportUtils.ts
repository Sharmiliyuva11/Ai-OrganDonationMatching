...
export function openPrintableReport(title: string, sections: ReportSection[], clinician?: string) {
  ...
  reportWindow.document.write(`
    ...
    <html>
      ...
      <body>
        ...
        <div class="meta">Generated ${escapeHtml(generatedAt)}${clinician ? ` · Generated by ${escapeHtml(clinician)}` : ''}</div>
        ${body}
      </body>
    </html>
  `)
